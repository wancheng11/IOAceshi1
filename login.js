document.addEventListener('DOMContentLoaded', function() {
    ...
    const users = {
        ...
        '12002': { password: '123456', name: '李四', department: '人事部' },
        '12003': { password: '123456', name: '王五', department: '财务部' },
        '12004': { password: '123456', name: '赵六', department: '市场部' }
    };
    ...
    loginForm.addEventListener('submit', function() {
        ...
        if (users[workId] && users[workId].password === password) {
            ...
            const userData = {
                ...
                avatar: users[workId].avatar || './images/default-avatar.png'
            };
